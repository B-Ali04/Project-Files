...
select    
    ...
    SHRTTRM.SHRTTRM_ASTD_DATE_END_OF_TERM SAP_DATE,
    SHRTTRM.SHRTTRM_TERM_CODE SAP_INTERIM,
    ...
    RPRATRM.RPRATRM_FUND_CODE FUND_CODE,
    RPRATRM.RPRATRM_AWST_CODE AWST_CODE
