select
    ...
    SARADAP.SARADAP_TERM_CODE_ENTRY Admission_Term_Code,
    ...
    SHRLGPA.SHRLGPA_HOURS_ATTEMPTED Cum_Hours_Attempted,
    SHRLGPA.SHRLGPA_HOURS_EARNED Cum_Hours_Earned,
...
from
    ...
    join STVTERM STVTERM on STVTERM.STVTERM_CODE = :Parm_Term_Code.STVTERM_CODE
    ...
    left outer join RORSAPR RORSAPR on RORSAPR.RORSAPR_PIDM = SPRIDEN.SPRIDEN_PIDM
         and RORSAPR.RORSAPR_TERM_CODE = STVTERM.STVTERM_CODE
