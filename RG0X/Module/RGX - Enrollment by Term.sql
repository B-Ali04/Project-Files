...
where
    ...
    and exists
      ...
      where SSBSECT.SSBSECT_TERM_CODE = :DropDown1.STVTERM_CODE
      and SSBSECT.SSBSECT_SUBJ_CODE = :DropDown4.Subject
      and SSBSECT.SSBSECT_CRSE_NUMB = :DropDown5.SSBSECT_CRSE_NUMB
